                ...
                <form name="form" id="form" onSubmit={doNothing}>
                    <div className="row">
                        <div className="col-12 mb-2 text-center d-flex justify-content-between">
                            <div>
                                {preguntaActual > 0
                                    ? <button className="btn btn-primary mr-2" name="left" onClick={event => navigateQuestions(event.target.name)} ><span><i className="fas fa-arrow-left flecha"></i></span></button>
                                    : <></>
                                }
